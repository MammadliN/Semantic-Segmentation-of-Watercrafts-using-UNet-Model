...
from Combine_Labels import get_label_patches, get_image_paths
...
if __name__ == '__main__':
    ...
    resized_ship_folder = r"/home/nmammadli/Downloads/Images/sized_Labeled_patches"
    resized_output_folder = r"/home/nmammadli/Downloads/Images"
    
    # Color & Resized Model names
    model_name25 = r"Models/Patched/Single_UNet/Color/patched_SingleUNet_color.hdf5"
    model_name26 = r"Models/Patched/Single_UNet/Color/patched_SingleUNet_color_dropout.hdf5"
    model_name27 = r"Models/Patched/Single_UNet/Color/patched_SingleUNet_color_weights.hdf5"
    model_name28 = r"Models/Patched/Single_UNet/Color/patched_SingleUNet_color_weights_dropout.hdf5"
    
    # Gray & Resized Model names
    model_name29 = r"Models/Patched/Single_UNet/Gray/patched_SingleUNet_gray.hdf5"
    model_name30 = r"Models/Patched/Single_UNet/Gray/patched_SingleUNet_gray_dropout.hdf5"
    model_name31 = r"Models/Patched/Single_UNet/Gray/patched_SingleUNet_gray_weights.hdf5"
    model_name32 = r"Models/Patched/Single_UNet/Gray/patched_SingleUNet_gray_weights_dropout.hdf5"
    
    model_names7 = [model_name25, model_name26]#, model_name27, model_name28]
    model_names8 = [model_name29, model_name30]#, model_name31, model_name32]
    ...
    train_masks_resized = get_label_patches(resized_ship_folder, resized_output_folder, label_color, color_mask=False, save=False, SIZE_X=SIZE_X, SIZE_Y=SIZE_Y)
    
    img_path = r"/home/nmammadli/Downloads/Images/sized_train_val_patches"
    mask_path = r"/home/nmammadli/Downloads/Images"
    ...
    models_color, historyies_color, times_color = train_and_evaluate_models(model_names7, train_images_color, train_masks_resized, X_train_color, X_test_color, X_test_unnormalized_color, y_train_cat_color, y_test_cat_color, y_test_color, test_img_number, n_classes, class_weights, epochs=epochs)
    models_gray, historyies_gray, times_gray = train_and_evaluate_models(model_names8, train_images_gray, train_masks_resized, X_train_gray, X_test_gray, X_test_unnormalized_gray, y_train_cat_gray, y_test_cat_gray, y_test_gray, test_img_number, n_classes, class_weights, epochs=epochs)