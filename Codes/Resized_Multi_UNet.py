...
# -*- coding: utf-8 -*-
"""
Created on Sun Oct 29 17:02:28 2023
...
if __name__ == '__main__':
    ...
    resized_sea_folder = r"/home/nmammadli/Downloads/new/mask/sea"
    resized_sky_folder = r"/home/nmammadli/Downloads/new/mask/sky"
    resized_ship_folder = r"/home/nmammadli/Downloads/new/mask/ship"
    resized_output_folder = r"/home/nmammadli/Downloads/new/result"
    
    # Color & Resized Model names
    model_name1 = r"Models/Resized/Multi_UNet/Color/resized_MultiUNet_color.hdf5"
    model_name2 = r"Models/Resized/Multi_UNet/Color/resized_MultiUNet_color_dropout.hdf5"
    model_name3 = r"Models/Resized/Multi_UNet/Color/resized_MultiUNet_color_weights.hdf5"
    model_name4 = r"Models/Resized/Multi_UNet/Color/resized_MultiUNet_color_weights_dropout.hdf5"
    
    # Gray & Resized Model names
    model_name5 = r"Models/Resized/Multi_UNet/Gray/resized_MultiUNet_gray.hdf5"
    model_name6 = r"Models/Resized/Multi_UNet/Gray/resized_MultiUNet_gray_dropout.hdf5"
    model_name7 = r"Models/Resized/Multi_UNet/Gray/resized_MultiUNet_gray_weights.hdf5"
    model_name8 = r"Models/Resized/Multi_UNet/Gray/resized_MultiUNet_gray_weights_dropout.hdf5"
    
    model_names1 = [model_name1, model_name2, model_name3, model_name4]
    model_names2 = [model_name5, model_name6, model_name7, model_name8]
    
    #Resizing images, if needed
    test_img_number = 36 #11, 13, 42
    epochs = 50
    SIZE_X = 256 
    SIZE_Y = 256
    ...
    train_masks_resized = combine_labels(resized_ship_folder, resized_sea_folder, resized_sky_folder, resized_output_folder, label_colors, label_priorities, color_mask=False, save=False, SIZE_X=SIZE_X, SIZE_Y=SIZE_Y)
    
    img_path = r"/home/nmammadli/Downloads/new/Image/Train"
    mask_path = r"/home/nmammadli/Downloads/new/Image/Train"
    ...
    models_color, historyies_color, times_color = train_and_evaluate_models(model_names1, train_images_color, train_masks_resized, X_train_color, X_test_color, X_test_unnormalized_color, y_train_cat_color, y_test_cat_color, y_test_color, test_img_number, n_classes, class_weights, epochs=epochs)
    models_gray, historyies_gray, times_gray = train_and_evaluate_models(model_names2, train_images_gray, train_masks_resized, X_train_gray, X_test_gray, X_test_unnormalized_gray, y_train_cat_gray, y_test_cat_gray, y_test_gray, test_img_number, n_classes, class_weights, epochs=epochs)